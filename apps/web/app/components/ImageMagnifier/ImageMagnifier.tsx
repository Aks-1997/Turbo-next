...
const ImageMagnifier = ({ initialImage, imageAlt, active, smallImage, largeImage, zoomLevel = '200%' }) => {
  ...
  const magnifier = e => {
    ...
    requestAnimationFrame(() => {
      const x = ((even.clientX - bound.left || 0) / container.offsetWidth) * 100;
      const y = ((even.clientY - bound.top || 0) / container.offsetHeight) * 100;
